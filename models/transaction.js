...
const transaction = [
    ...
    { id: "mno456", item_name: "new phone", amount: -600, date: "2024-07-26", from: "electronics store", category: "expense" },
    { id: "pqr789", item_name: "gym membership", amount: -40, date: "2024-07-27", from: "gym", category: "expense" },
    { id: "stu012", item_name: "freelance project", amount: 1000, date: "2024-07-28", from: "client", category: "income" },
    { id: "vwx345", item_name: "dinner party", amount: -200, date: "2024-07-29", from: "restaurant", category: "expense" },
    { id: "yz6789", item_name: "book purchase", amount: -30, date: "2024-07-30", from: "bookstore", category: "expense" },
    { id: "abc012", item_name: "bonus", amount: 300, date: "2024-07-31", from: "employer", category: "income" },
    { id: "klm123", item_name: "car repair", amount: -300, date: "2024-08-01", from: "mechanic", category: "expense" },
    { id: "nop456", item_name: "coffee", amount: -5, date: "2024-08-02", from: "cafe", category: "expense" },
    { id: "qrs789", item_name: "freelance gig", amount: 700, date: "2024-08-03", from: "client", category: "income" },
    { id: "tuv012", item_name: "clothes shopping", amount: -150, date: "2024-08-04", from: "clothing store", category: "expense" },
    { id: "wxy345", item_name: "music concert", amount: -100, date: "2024-08-05", from: "ticket vendor", category: "expense" },
    { id: "zab678", item_name: "investment return", amount: 200, date: "2024-08-06", from: "investment company", category: "income" },
    { id: "cde901", item_name: "dining out", amount: -80, date: "2024-08-07", from: "restaurant", category: "expense" },
    { id: "fgh234", item_name: "gym equipment", amount: -250, date: "2024-08-08", from: "sports store", category: "expense" },
    { id: "ijk567", item_name: "freelance project", amount: 600, date: "2024-08-09", from: "client", category: "income" },
    { id: "lmn890", item_name: "utility bill", amount: -90, date: "2024-08-10", from: "electric company", category: "expense" },
    { id: "opq123", item_name: "grocery shopping", amount: -120, date: "2024-08-11", from: "supermarket", category: "expense" },
    { id: "rst456", item_name: "bonus payment", amount: 500, date: "2024-08-12", from: "employer", category: "income" },
    { id: "uvw789", item_name: "new laptop", amount: -1200, date: "2024-08-13", from: "electronics store", category: "expense" },
    { id: "xyz012", item_name: "rental income", amount: 750, date: "2024-08-14", from: "tenant", category: "income" },
    { id: "abc345", item_name: "haircut", amount: -25, date: "2024-08-15", from: "barber", category: "expense" },
    { id: "def678", item_name: "subscription fee", amount: -15, date: "2024-08-16", from: "service provider", category: "expense" },
    { id: "ghi901", item_name: "consulting work", amount: 400, date: "2024-08-17", from: "client", category: "income" },
    { id: "jkl234", item_name: "car wash", amount: -20, date: "2024-08-18", from: "car wash", category: "expense" },
    { id: "mno567", item_name: "gift purchase", amount: -60, date: "2024-08-19", from: "gift shop", category: "expense" },
    { id: "pqr890", item_name: "movie streaming", amount: -12, date: "2024-08-20", from: "streaming service", category: "expense" }
];
